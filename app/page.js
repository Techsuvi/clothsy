        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <div className="flex w-full md:justify-start justify-center items-end">
              ...
              <button className="inline-flex cursor-pointer text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
            </div>
            ...
            <div className="flex lg:flex-row md:flex-col">
              <Link href="https://play.google.com/store/games?hl=en">
                <button className="bg-gray-100 inline-flex py-3 px-5 rounded-lg cursor-pointer items-center hover:bg-gray-200 focus:outline-none">
              ...
              <Link href="https://www.apple.com/in/app-store/">
                <button className="bg-gray-100 inline-flex py-3 cursor-pointer px-5 rounded-lg items-center lg:ml-4 md:ml-0 ml-4 md:mt-4 mt-0 lg:mt-0 hover:bg-gray-200 focus:outline-none">
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <img className="object-cover object-center rounded" alt="hero" src="/cover.jpg" />
          </div>
        </div>
      </section>
