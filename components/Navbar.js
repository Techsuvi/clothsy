    ...
    <>
      <div className="flex flex-col overflow-x-hidden md:flex-row md:justify-start justify-center items-center my-2 shadow-md sticky bg-white z-10 top-0">
        ...
        <div
          ...
          className="cart absolute right-0 mx-5 top-4 cursor-pointer flex" >
       <Link href={'/login'}>   <MdAccountCircle className=" mx-3 text-3xl font-bold text-blue-500 md:text-2xl" /></Link>

          <AiOutlineShoppingCart onClick={toggleCart} className="text-3xl font-bold text-blue-500 md:text-2xl" />
        </div>
